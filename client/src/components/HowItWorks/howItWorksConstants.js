  ...
  services: [
    {
      ...
      icon: 'https://www.atom.com/html/html/static_images/contests/g1.svg',
    ...
    },
    {
      ...
      icon: 'https://www.atom.com/html/html/static_images/contests/g2.svg',
    ...
    },
    {
      ...
      description:
        'Work with hundreds of creative experts to get custom name suggestions for your business or brand. All names are auto-checked for URL availability.',
      icon: 'https://www.atom.com/html/html/static_images/contests/g3.svg',
  ...
  faq: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            '<p>While it is unusually rare that you will not like any names provided, we have a few options in case this problem occurs:</p><ul><li> If the contest ends and you have not yet found a name that you’d like to move forward with, we can provide complimentary extension of your contest as well as a complimentary consultation with one of our branding consultants (a $99 value). </li><li> By exploring our premium domain marketplace you can apply the contest award towards the purchase of any name listed for sale. </li><li>If you choose the Gold package or Platinum package and keep the contest as "Not Guaranteed", you can request a partial refund if you choose not to move forward with any name from you project. (Please note that the refund is for the contest award). Here is a link to our <a href="https://helpdesk.atom.com/en/articles/115621-refund-policy" target="_blank">Refund Policy</a></li></ul>',
        },
        {
          question: 'How much does it cost?',
          answer:
            '<p>Our naming competitions start at $299, and our logo design competitions start at $299. Also, there are three additional contest level that each offer more features and benefits. See our <a href="/pricing">Pricing Page</a> for details</p>',
        },
        {
          question:
            'I need both a Name and a Logo. Do you offer any discount for multiple contests?',
          answer:
            '<p>Yes! We have many contest bundles - our most popular being our Name, Tagline, and Logo bundle. Bundles allow you to purchase multiple contests at one time and save as much as from $75 - $400. You can learn more about our bundle options on our <a href="/pricing.php?bundle-id=4">Pricing Page</a></p>',
        },
        {
        ...
        },
        {
          ...
          answer:
            "<p>Absolutely. Atom services organizations across the globe. Our customer come from many countries, such as the United States, Australia, Canada, Europe, India, and MENA. We've helped more than 25,000 customer around the world.</p>",
        },
        {
          question: 'Can I see any examples?',
          answer:
            '<p>Our creatives have submitted more than 6 Million names and thousands of logos on our platform. Here are some examples of Names, Taglines, and Logos that were submitted in recent contests.</p><ul><li><a href="/Name-Ideas">Name Examples</a></li><li><a href="/tagline-slogan-ideas">Tagline Examples</a></li><li><a href="/logo-design-examples">Logo Examples</a></li></ul>',
        },
      ],
    },
    {
      tab: 'Buying From Marketplace',
      id: 'marketplace',
      questions: [
        {
          question: "What's included with a Domain Purchase?",
          answer:
            '<p>When you purchase a domain from our premium domain marketplace, you will receive the exact match .com URL, a complimentary logo design (along with all source files), as well as a complimentary Trademark report and Audience Testing if you’re interested in validating your name.</p>',
        },
        {
          question: 'How does the Domain transfer process work?',
          answer:
            '<p>Once you purchase a Domain, our transfer specialists will reach out to you (typically on the same business day). In most cases we can transfer the domain to your preferred registrar (such as GoDaddy). Once we confirm the transfer details with you, the transfers are typically initiated to your account within 1 business day.</p>',
        },
        {
          question:
      ...
      questions: [
        {
          ...
          answer:
            "<p>We are open to anyone to signup. However, we have an extensive '<a href='https://helpdesk.atom.com/en/articles/91702-percentile-ranking-score' target='_blank'>Quality Scoring</a>' process which ensures that high quality creatives have the ability to continue to participate in the platform. On the other hand, we limit the participation from those creatives who do not consistently receive high ratings.</p>",
        },
        {
